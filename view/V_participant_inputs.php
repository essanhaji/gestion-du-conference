...
<body>
       ...
       <?php
            ...
            $dao = new DAO('pfe');
            $var = array();
            $var = $dao->GetRow('participant', $_GET['id']);
            
       ?>

    <form class="add2" method="post" action="../controler/P_update_participant.php">                
        <div class="form-group">
            ...
            <input type="text" name="phone_number"  placeholder="Phone number:"  value="<?= $var[0]->phone_number  ?>" required>
            <div class="well well-sm" style="margin-left: 25px;margin-right: 25px"><?= $var[0]->registration_date  ?></div>
            <div id="msg" ></div>
        </div>
        <hr>
