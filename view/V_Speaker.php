...
<header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span class="ion-speakerphone" aria-hidden="true"></span> Speakers <small> Speakers Management
</small></h1>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="V_Speaker.php" class="list-group-item active main-color-bg"><span class="ion-speakerphone" aria-hidden="true"></span> Speakers</span></a>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                ...
                                <div class="modal-header">
                                        <h5 class="modal-title" style="display:inline-block;font-size:20px"><b>Add New Speaker</b></h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
                                <form action="../controler/S_add_speaker.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" rows="4" cols="100" placeholder="Description, About Speaker :" style="width:90%;clear:both;display:block"></textarea>
                                            <br><br>

                                                    <div class="input-group" style="margin-left:7%">
                                                        <label class="input-group-btn">
                                                            <span class="btn btn-primary" class="margin:0">
                                                                Upload Picture 
                                                                <input type="file" name="picture" style="display: none;" multiple>
                                                            </span>
                                                        </label>
                                                        <input type="text" class="form-control" readonly style="width:92%;margin:0">
                                                    </div>
                                           <br>
                                        </div>    
                                </div>
                                ...
                                <tr class="header">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button  onclick="delete_speaker(<?php echo $value->getid() ?>)"  type="submit" name="delete_admin_btn" class="btn btn-danger" id="<?php echo $value->getid() ?>">Delete</button>
                                        </td>
                                    </tr>
                                  
                                    
                                     <?php /** End Of List SPEAKERS */
                                    }
                                    ?>
