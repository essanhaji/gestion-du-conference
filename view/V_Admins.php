                    ...
                    <div class="panel-body">
                        ...
                        <table id="myTable" class="table table-striped table-hover">
                                ...
                                <tr class="header">
                                    ...
                                    <?php  /****** Start : Of List Admins ******/
                                    $tab = array();
                                    $tab = Admin::showAllAdmin();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button  onclick="delete_admin(<?php echo $value->getid() ?>)"  type="submit" name="delete_admin_btn" class="btn btn-danger" id="<?php echo $value->getid() ?>">Delete</button>
                                        </td>
                                    </tr>
                                  
                                    
                                     <?php /** End Of List Admins */
                                    }
                                    ?>
